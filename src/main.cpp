...
int64 nChainStartTime = 1398441332;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in sportscoin
    bool fStrictPayToScriptHash = true; // Always active in sportscoin
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("c52bd3b26727f0ab22fe5731a1048206e904651684e5be76342894dbaab4e381"));
